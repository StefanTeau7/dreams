...
class Chat extends Model {
  ...
  const Chat._internal({required this.id, text, required dreamID, chatIndex, role, required userID, createdAt, updatedAt}): _text = text, _dreamID = dreamID, _chatIndex = chatIndex, _role = role, _userID = userID, _createdAt = createdAt, _updatedAt = updatedAt;
  
  factory Chat({String? id, String? text, required String dreamID, int? chatIndex, ChatRoleType? role, required String userID}) {
  ...
  Map<String, dynamic> toJson() => {
    'id': id, 'text': _text, 'dreamID': _dreamID, 'chatIndex': _chatIndex, 'role': enumToString(_role), 'userID': _userID, 'createdAt': _createdAt?.format(), 'updatedAt': _updatedAt?.format()
  };
  
  Map<String, Object?> toMap() => {
    'id': id, 'text': _text, 'dreamID': _dreamID, 'chatIndex': _chatIndex, 'role': _role, 'userID': _userID, 'createdAt': _createdAt, 'updatedAt': _updatedAt
  };
